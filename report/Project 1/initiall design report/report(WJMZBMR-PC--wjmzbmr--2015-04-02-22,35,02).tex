...
%	
	...
	Set up a single resource, and fork many threads which waits for it, check whether they are executed in the correct order.
	
	\subsubsection*{Many conditions}
	Set up a couple of condition variables, and many threads waiting on them, print the thread denoting process and the queue content, to ensure that the priority is donated correctly and the thread are executed in the correct order of the effective priority.
%	
